...
const EditModal = (props) => {
  ...
  const saveChangedData = () => {
    setEditModal({ ...editModal, open: false, type: type })
  }
      ...
      <Modal.Body>
        <div className="positison-relative">
          ...
          <div className="content">
            ...
            {type['employeeNum'] && <div className="txt">My current position is <span className="detail">CFO.</span></div>}
            {type['position'] && <div className="txt">My phone number is <span className="detail">+XX-X-XXX-XXXX.</span></div>}
            {type['phoneNum'] && <div className="txt">My work email is <span className="detail">jane.smith@company.com</span></div>}
            {type['email'] && <div className="txt">I will like to discuss this <span className="discuss-content">“I have recently helped a 3 billion automative company in Germany reduce 30% of their company tax overhead”</span></div>}
          </div>
